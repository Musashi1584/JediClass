...
//			`LOG("UISL_TacticalHUD_JediStats UpdateGameSpeed" @ class'X2Effect_ForceSpeed'.default.ForceSpeedGameSpeedMutliplier @ "active ForceSpeed on" @ UnitState.GetFullName(),, 'JediClassWOTC');
//		}
//	}
//	else
//	{
...
//			`LOG("UISL_TacticalHUD_JediStats UpdateGameSpeed 1" @ UnitState.GetFullName(),, 'JediClassWOTC');
//		}
//	}
//}
...
function EventListenerReturn OnKillMail(Object EventData, Object EventSource, XComGameState GameState, Name EventID, Object CallbackData)
{
	...
	{
		`LOG("UISL_TacticalHUD_JediStats Innocent Killer" @ Killer.GetFullName(),, 'JediClassWOTC');
...
function EventListenerReturn OnUnitEvacuated(Object EventData, Object EventSource, XComGameState GameState, Name EventID, Object CallbackData)
{
	...
	if (CarryEffect != none)
	{
		...
		if (bFoundCarry)
		{
			`LOG("UISL_TacticalHUD_JediStats Savior" @ UnitState.GetFullName(),, 'JediClassWOTC');
	...
	{
		`LOG("UISL_TacticalHUD_JediStats Pacifist" @ UnitState.GetFullName(),, 'JediClassWOTC');
		class'JediClassHelper'.static.AddLightSidePoint(UnitState);
	}
