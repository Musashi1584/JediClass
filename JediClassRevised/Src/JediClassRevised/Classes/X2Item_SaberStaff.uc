...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	ModWeapons.AddItem(CreateTemplate_Saberstaff_TR());
...
static function X2DataTemplate CreateTemplate_Saberstaff_TR()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'Saberstaff_TR');
