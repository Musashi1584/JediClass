...
static function X2DataTemplate CreateJediUpgrade(name SocketName, UpgradeSetup ThisUpgradeSetup)
{
	...
	`log("-------------------------------------------------------------------------", default.bLogUpgrades, 'JediClassRevised');
	`log(default.class @ GetFuncName() @ "setting up" @ ThisUpgradeSetup.UpgradeName, default.bLogUpgrades, 'JediClassRevised');
	`log(default.class @ GetFuncName() @ "SocketName" @ SocketName, default.bLogUpgrades, 'JediClassRevised');
	...
	`log(default.class @ GetFuncName() @ "AimBonus" @ ThisUpgradeSetup.AimBonus, default.bLogUpgrades, 'JediClassRevised');
	...
	`log(default.class @ GetFuncName() @ "CritBonus" @ ThisUpgradeSetup.CritChanceBonus, default.bLogUpgrades, 'JediClassRevised');
	...
	{
		`log(default.class @ GetFuncName() @ "Bonus Ability" @ AbilityName, default.bLogUpgrades, 'JediClassRevised');
	...
	`log(default.class @ GetFuncName() @ "ResourceCosts 0 index check" @ ThisUpgradeSetup.ResourceCosts[0].ItemTemplateName, default.bLogUpgrades, 'JediClassRevised');
	`log(default.class @ GetFuncName() @ "ArtifactCosts 0 index check" @ ThisUpgradeSetup.ArtifactCosts[0].ItemTemplateName, default.bLogUpgrades, 'JediClassRevised');
	`log(default.class @ GetFuncName() @ "RequiredTechs 0 index check" @ ThisUpgradeSetup.RequiredTechs[0], default.bLogUpgrades, 'JediClassRevised');
	...
	`log(default.class @ GetFuncName() @ "finished setting up" @ ThisUpgradeSetup.UpgradeName, default.bLogUpgrades, 'JediClassRevised');
