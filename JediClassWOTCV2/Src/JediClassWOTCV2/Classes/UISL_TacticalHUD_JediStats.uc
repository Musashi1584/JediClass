...
//			`LOG("UISL_TacticalHUD_JediStats UpdateGameSpeed" @ class'X2Effect_ForceSpeed'.default.ForceSpeedGameSpeedMutliplier @ "active ForceSpeed on" @ UnitState.GetFullName(),, 'JediClassWOTCV2');
//		}
//	}
//	else
//	{
...
//			`LOG("UISL_TacticalHUD_JediStats UpdateGameSpeed 1" @ UnitState.GetFullName(),, 'JediClassWOTCV2');
//		}
//	}
//}
...
function EventListenerReturn OnKillMail(Object EventData, Object EventSource, XComGameState GameState, Name EventID, Object CallbackData)
{
	...
	{
		`LOG("UISL_TacticalHUD_JediStats Innocent Killer" @ Killer.GetFullName(),, 'JediClassWOTCV2');
...
function EventListenerReturn OnUnitEvacuated(Object EventData, Object EventSource, XComGameState GameState, Name EventID, Object CallbackData)
{
	...
	if (CarryEffect != none)
	{
		...
		if (bFoundCarry)
		{
			`LOG("UISL_TacticalHUD_JediStats Savior" @ UnitState.GetFullName(),, 'JediClassWOTCV2');
	...
	{
		`LOG("UISL_TacticalHUD_JediStats Pacifist" @ UnitState.GetFullName(),, 'JediClassWOTCV2');
		class'JediClassHelper'.static.AddLightSidePoint(UnitState);
	}
